...
const wrappedCreateIndexTrigger = fft.wrap(
    createIndexTrigger
)
...
describe('createIndex', () => {
    ...
    test("should not run if no status", async () => {
        ...
        await simulateFunctionTriggered(wrappedCreateIndexTrigger)(ref, beforeSnapshot);
    ...
    test("should run if status is changed", async () => {
        ...
        const beforeSnapshot = fft.firestore.makeDocumentSnapshot(taskBefore, ref.path);
        await simulateFunctionTriggered(wrappedCreateIndexTrigger)(ref, beforeSnapshot);

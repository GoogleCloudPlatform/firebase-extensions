...
**Description**: Search for semantically similar text documents in Firestore with Gemini API and Vertex AI Matching Engine.
...
* Embeddings method: Do you want to use [Gemini](https://ai.google.dev/docs/embeddings_guide), [Universal Sentence Encoder](https://tfhub.dev/google/universal-sentence-encoder/4), or [PaLM (Deprecated)](https://developers.generativeai.google/guide/palm_api_overview) for embeddings?

* Google AI API Key (Gemini only): If you have selected Gemini as your embeddings provider, then this parameter is **required**.
